...
//  Malkut
//
//  Created by SMK IDN MI on 12/1/17.
...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://localhost/Malkut/index.php/api/getnama"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellResep", for: indexPath) as! TableViewCell
